...
# First pass optimum: glob_bw =  0.04 with a spacing of 0.01
par_grid = {"glob_bw": np.arange(0.03, 0.05, 0.001)}
...
fname = "./CV{:d}_{}_EXP_IC86I_CUT_sig.ll.{:d}_PARS_diag_{}_alpha_{:.1f}_pass2.pickle".format(
