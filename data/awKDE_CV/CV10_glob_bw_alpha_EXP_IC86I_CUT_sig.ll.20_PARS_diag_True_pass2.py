...
# First pass optimum: alpha = 0.455, glob_bw = 0.0472
par_grid = {"glob_bw": np.arange(0.035, 0.06, 0.0025),
            "alpha": np.arange(0.35, 0.6, 0.05)}
...
fname = "./CV{:d}_{}_EXP_IC86I_CUT_sig.ll.{:d}_PARS_diag_{}_pass2.pickle".format(
